...
function initGame() {
    ...
    // 背景图片
    let logo = new Image();
    logo.src = "image/sky.png";
    logo.onload = function () {
        context.save(); // 保存当前状态
        context.globalAlpha = 0.3; // 设置透明度，0.0~1.0，越小越淡
        context.drawImage(logo, 0, 0, 450, 450);
        context.globalAlpha = 1.0; // 恢复为不透明，防止影响后续绘制
    ...
    function initChessBoard() {
        context.lineWidth = 2; // 加粗线条
        context.strokeStyle = "#444"; // 线颜色（可选）
        for (let i = 0; i < 15; i++) {
